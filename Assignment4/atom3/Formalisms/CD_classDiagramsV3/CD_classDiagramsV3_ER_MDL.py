...
Author: Ujean
Modified: Mon May 04 10:14:13 2009
...
def CD_classDiagramsV3_ER_MDL(self, rootNode, EntityRelationshipV3RootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_Entity3(420.0,60.0,self.obj23)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("Entity3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.8212962962962964, 6.1584269662921347]
...
(self.obj23,self.obj24,[421.0, 183.83146067415731, 245.00000000000003, 137.0, 245.00000000000003, 302.0],"true", 3),
(self.obj23,self.obj25,[712.40740740740694, 430.16853932584303, 859.99999999999989, 445.0, 859.99999999999989, 302.0],"true", 3) )
    # Connections for obj24 (graphObject_: Obj1) named CD_Association3
    self.drawConnections(
(self.obj24,self.obj23,[245.00000000000003, 302.0, 245.00000000000003, 467.00000000000006, 421.0, 430.16853932584303],"true", 3) )
    # Connections for obj25 (graphObject_: Obj3) named CD_Inheritance3
    self.drawConnections(
(self.obj25,self.obj23,[859.99999999999989, 302.0, 859.99999999999989, 159.0, 712.40740740740694, 183.83146067415731],"true", 3) )
