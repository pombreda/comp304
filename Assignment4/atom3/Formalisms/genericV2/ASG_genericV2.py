"""
__ASG_genericV2.py_____________________________________________________
...
class ASG_genericV2(ASG, ATOM3Type):

   def __init__(self, parent= None, ASGroot = None):
      ASG.__init__(self, 'genericV2', ASGroot, ['ASG_genericV2' ,'genericEntityV2' ,'genericLinkV2'])
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'genericV2', 0, 1, self)
