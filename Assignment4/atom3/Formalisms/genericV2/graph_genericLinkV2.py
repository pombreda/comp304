"""
__graph_genericLinkV2.py___________________________________________________________

Automatically generated LINK for entity genericLinkV2
...
class graph_genericLinkV2(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('genericLinkV2_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('genericLinkV2_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('genericLinkV2_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('genericLinkV2_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('genericLinkV2_2ndLink', self.le.SecondLink))
