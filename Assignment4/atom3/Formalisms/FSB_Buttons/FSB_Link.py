"""
__FSB_Link.py_____________________________________________________
...
from graph_FSB_Link import *
class FSB_Link(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_FSB_Link
      self.isGraphObjectVisual = False
      if(hasattr(self, '_setHierarchicalLink')):
        self._setHierarchicalLink(True)
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = FSB_Link( self.parent )
