"""
__ASG_FSB_Buttons.py_____________________________________________________
...
class ASG_FSB_Buttons(ASG, ATOM3Type):

   def __init__(self, parent= None, ASGroot = None):
      ASG.__init__(self, 'FSB_Buttons', ASGroot, ['ASG_FSB_Buttons' ,'FSB_Toolbar' ,'FSB_Button' ,'FSB_Link' ,'FBS_BLink'])
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'FSB_Buttons', 0, 1, self)
