"""
__FBS_BLink.py_____________________________________________________
...
from graph_FBS_BLink import *
class FBS_BLink(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_FBS_BLink
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = FBS_BLink( self.parent )
