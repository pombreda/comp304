"""
__graph_Relationship3.py___________________________________________________________

Automatically generated LINK for entity Relationship3
...
class graph_Relationship3(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('Relationship3_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('Relationship3_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('Relationship3_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('Relationship3_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.arrowShape2=ATOM3Integer(15)
      self.le.SecondLink.arrowShape3=ATOM3Integer(9)
      self.le.SecondLink.decoration=ATOM3Appearance()
      self.le.SecondLink.decoration.setValue( ('Relationship3_2ndLink', self.le.SecondLink))
