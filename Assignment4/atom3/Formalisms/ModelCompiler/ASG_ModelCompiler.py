"""
__ASG_ModelCompiler.py_____________________________________________________
...
class ASG_ModelCompiler(ASG, ATOM3Type):

   def __init__(self, parent= None, ASGroot = None):
      ASG.__init__(self, 'ModelCompiler', ASGroot, ['ASG_ModelCompiler'])
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'ModelCompiler', 0, 1, self)
