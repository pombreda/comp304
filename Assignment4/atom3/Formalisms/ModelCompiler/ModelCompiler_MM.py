"""
__ModelCompiler_MM.py______________________________________________________

Automatically generated AToM3 MetaModel (DO NOT MODIFY DIRECTLY)
Author: Uj
Modified: Mon Oct 22 23:10:00 2007
___________________________________________________________________________
"""
from ASG_ModelCompiler import *
...
def createNewASGroot(self):
   return ASG_ModelCompiler(self, None)
...
def setConnectivity(self):
    ...
    self.entitiesInMetaModel['ModelCompiler']=[]

    
def createNew_Model(self, wherex, wherey, screenCoordinates = 1):
   self.toClass = None
   self.fromClass = None
   new_semantic_obj = ASG_ModelCompiler(self)
   ne = len(self.ASGroot.listNodes["ASG_ModelCompiler"])
   ...
   self.UMLmodel.addtag_withtag("ASG_ModelCompiler", new_obj.tag)
