# _ File: graph_TTPN_Transition_Place_Rel.py__________________________________________________________________________________
#  Graphical LINK for entity TTPN_Transition_Place_Rel, generated by ATOM3
# ______________________________________________________________________________________________________
from graphLink import *
from stickylink import *
from widthXfillXdecoration import *
class graph_TTPN_Transition_Place_Rel(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "TTPN_Transition_Place_Rel")
      ...
      self.le.FirstLink.decoration.setValue( ('TTPN_Transition_Place_Rel_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('TTPN_Transition_Place_Rel_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('TTPN_Transition_Place_Rel_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('TTPN_Transition_Place_Rel_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('TTPN_Transition_Place_Rel_2ndLink', self.le.SecondLink))
