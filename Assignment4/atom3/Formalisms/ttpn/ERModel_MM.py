...
from relationship0       import *
from relationship1       import *
def createNewASGroot(self):
   return ASG_ERModel(self, None)
...
def createModelMenu(self, modelMenu):
    ...
    modelMenu.add_command(label="new relationship0", command=lambda x=self: x.newModesrelationship0(x) )
    modelMenu.add_command(label="new relationship1", command=lambda x=self: x.newModesrelationship1(x) )
def setConnectivity(self):
    self.ConnectivityMap['TTPN_Place']={
           'TTPN_Place': []
          ,'relationship1': []
          ,'relationship0': []
          ,'TTPN_Transition': [( 'relationship0', self.createNewrelationship0)] }
    self.ConnectivityMap['relationship1']={
           'TTPN_Place': []
          ,'relationship1': []
          ,'relationship0': [( 'TTPN_Place', self.createNewTTPN_Place)]
          ,'TTPN_Transition': [] }
    self.ConnectivityMap['relationship0']={
           'TTPN_Place': []
          ,'relationship1': [( 'TTPN_Transition', self.createNewTTPN_Transition)]
          ,'relationship0': []
          ,'TTPN_Transition': [] }
    self.ConnectivityMap['TTPN_Transition']={
           'TTPN_Place': [( 'relationship1', self.createNewrelationship1)]
          ,'relationship1': []
          ,'relationship0': []
          ,'TTPN_Transition': [] }
    ...
    self.CardinalityTable['TTPN_Place']={
          'TTPN_Place': []
          ,'TTPN_Transition': []
          ,'relationship0': [('1', '1', 'Source')]
          ,'relationship1': [('1', '1', 'Destination')] }
    self.CardinalityTable['TTPN_Transition']={
          'TTPN_Place': []
          ,'TTPN_Transition': []
          ,'relationship0': [('1', '1', 'Destination')]
          ,'relationship1': [('1', '1', 'Source')] }
    self.CardinalityTable['relationship0']={
          'TTPN_Place': [('1', '1', 'Destination')]
          ,'TTPN_Transition': [('1', '1', 'Source')]
          ,'relationship0': []
          ,'relationship1': [] }
    self.CardinalityTable['relationship1']={
          'TTPN_Place': [('1', '1', 'Source')]
          ,'TTPN_Transition': [('1', '1', 'Destination')]
          ,'relationship0': []
          ,'relationship1': [] }
    
    self.entitiesInMetaModel['ERModel']=["TTPN_Place", "TTPN_Transition", "relationship0", "relationship1"]
...
def createNewTTPN_Transition(self, wherex, wherey, screenCoordinates = 1):
   ...
   if self.editGGLabel :
      ...
      self.statusbar.event(StatusBar.MODEL, StatusBar.CREATE)
   return new_semantic_obj
def createNewrelationship0(self, wherex, wherey, screenCoordinates = 1):
   self.fromClass = None
   self.toClass = None
   # try the global constraints...
   res = self.ASGroot.preCondition(ASG.CREATE)
   ...
   new_semantic_obj = relationship0(self)
   ne = len(self.ASGroot.listNodes["relationship0"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
      new_obj = graph_relationship0(self.UMLmodel.canvasx(wherex), self.UMLmodel.canvasy(wherey), new_semantic_obj)
   else: # already in canvas coordinates
      new_obj = graph_relationship0(wherex, wherey, new_semantic_obj)
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
   self.UMLmodel.addtag_withtag("relationship0", new_obj.tag)
   new_semantic_obj.graphObject_ = new_obj
   self.ASGroot.addNode(new_semantic_obj)
   res = self.ASGroot.postCondition(ASG.CREATE)
   if res:
   ...
   if self.editGGLabel :
      ...
      self.statusbar.event(StatusBar.MODEL, StatusBar.CREATE)
   return new_semantic_obj
def createNewrelationship1(self, wherex, wherey, screenCoordinates = 1):
   self.fromClass = None
   self.toClass = None
   # try the global constraints...
   res = self.ASGroot.preCondition(ASG.CREATE)
   ...
   new_semantic_obj = relationship1(self)
   ne = len(self.ASGroot.listNodes["relationship1"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
      new_obj = graph_relationship1(self.UMLmodel.canvasx(wherex), self.UMLmodel.canvasy(wherey), new_semantic_obj)
   else: # already in canvas coordinates
      new_obj = graph_relationship1(wherex, wherey, new_semantic_obj)
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
   self.UMLmodel.addtag_withtag("relationship1", new_obj.tag)
   new_semantic_obj.graphObject_ = new_obj
   self.ASGroot.addNode(new_semantic_obj)
   res = self.ASGroot.postCondition(ASG.CREATE)
   if res:
...
def createNew_Model(self, wherex, wherey, screenCoordinates = 1):
   self.toClass = None
   self.fromClass = None
   new_semantic_obj = ASG_ERModel(self)
   ne = len(self.ASGroot.listNodes["ASG_ERModel"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
   ...
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
   self.UMLmodel.addtag_withtag("ASG_ERModel", new_obj.tag)
   new_semantic_obj.graphObject_ = new_obj
   self.ASGroot.addNode(new_semantic_obj)
   self.mode=self.IDLEMODE
   if self.editGGLabel :
