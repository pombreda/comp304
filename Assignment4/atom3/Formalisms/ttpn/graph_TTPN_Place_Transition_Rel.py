# _ File: graph_TTPN_Place_Transition_Rel.py__________________________________________________________________________________
#  Graphical LINK for entity TTPN_Place_Transition_Rel, generated by ATOM3
# ______________________________________________________________________________________________________
from graphLink import *
from stickylink import *
from widthXfillXdecoration import *
class graph_TTPN_Place_Transition_Rel(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "TTPN_Place_Transition_Rel")
      ...
      self.le.FirstLink.decoration.setValue( ('TTPN_Place_Transition_Rel_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('TTPN_Place_Transition_Rel_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('TTPN_Place_Transition_Rel_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('TTPN_Place_Transition_Rel_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.arrowShape2=ATOM3Integer(6)
      self.le.SecondLink.arrowShape3=ATOM3Integer(6)
      self.le.SecondLink.decoration=ATOM3Appearance()
      self.le.SecondLink.decoration.setValue( ('TTPN_Place_Transition_Rel_2ndLink', self.le.SecondLink))
