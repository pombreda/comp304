# _ File: graph_relationship1.py__________________________________________________________________________________
#  Graphical LINK for entity relationship1, generated by ATOM3
# ______________________________________________________________________________________________________
from graphLink import *
from stickylink import *
from widthXfillXdecoration import *
class graph_relationship1(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "relationship1")
      ...
      self.le.FirstLink.decoration.setValue( ('relationship1_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('relationship1_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('relationship1_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('relationship1_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('relationship1_2ndLink', self.le.SecondLink))
