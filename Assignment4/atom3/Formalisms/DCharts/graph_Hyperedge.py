"""
__graph_Hyperedge.py___________________________________________________________

Automatically generated LINK for entity Hyperedge
...
class graph_Hyperedge(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.arrowShape1=ATOM3Integer(3)
      ...
      self.le.FirstLink.decoration.setValue( ('Hyperedge_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('Hyperedge_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('Hyperedge_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('Hyperedge_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.arrowShape2=ATOM3Integer(9)
      self.le.SecondLink.arrowShape3=ATOM3Integer(6)
      self.le.SecondLink.decoration=ATOM3Appearance()
      self.le.SecondLink.decoration.setValue( ('Hyperedge_2ndLink', self.le.SecondLink))
