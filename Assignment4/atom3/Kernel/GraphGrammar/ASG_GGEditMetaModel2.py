# __ASG_GGEditMetaModel2.py_____________________________________________________
from ASG import *
from ATOM3Type       import *
from ATOM3           import *
class ASG_GGEditMetaModel2(ASG, ATOM3Type):

   def __init__(self, parent= None, ASGroot = None):
      ASG.__init__(self, ASGroot, ['ASG_GGEditMetaModel2' ,'GraphGrammarEdit'])
   ...
   def clone(self):
      cloneObject = GGEditMetaModel2( self.parent )
      return cloneObject
   def copy(self, other):
