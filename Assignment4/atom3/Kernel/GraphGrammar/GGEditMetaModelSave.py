...
def GGEditMetaModelSave(self, rootNode):
    ...
    cobj0.initialValue=ATOM3String('')
    lcobj0.append(cobj0)
    cobj0=ATOM3Attribute(self.types)                # Eugene Syriani 03/05/08
    cobj0.setValue(('NAC', 'String', None, 0, 0))   # Eugene Syriani 03/05/08
    cobj0.initialValue=ATOM3String('')              # Eugene Syriani 03/05/08
    lcobj0.append(cobj0)                            # Eugene Syriani 03/05/08
    cobj0=ATOM3Attribute(self.types)
